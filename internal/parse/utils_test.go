...
func TestToString(t *testing.T) {
	tests := []struct {
		...
		{name: "null input", input: "null", wantErr: ErrNull},
		{name: "unquoted garbage", input: "abc", wantErr: ErrNotString},
		{name: "boolean", input: "true", wantErr: ErrNotString},
		{name: "array", input: "[]", wantErr: ErrNotString},
		{name: "object", input: "{}", wantErr: ErrNotString},
		{name: "int", input: "24", wantErr: ErrNotString},
		{name: "float", input: "24.4", wantErr: ErrNotString},
